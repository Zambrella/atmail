...
class ConversationStateMapper extends ClassMapperBase<ConversationState> {
  ...
  static const Field<ConversationState, ConversationStatus> _f$status =
  ...
  static const Field<ConversationState, Exception> _f$exception =
...
mixin ConversationStateMappable {
  ...
  ConversationStateCopyWith<ConversationState, ConversationState,
          ConversationState>
      get copyWith =>
          _ConversationStateCopyWithImpl<ConversationState, ConversationState>(
              this as ConversationState, $identity, $identity);
  @override
  String toString() {
    return ConversationStateMapper.ensureInitialized()
        .stringifyValue(this as ConversationState);
  }

  @override
  bool operator ==(Object other) {
    return ConversationStateMapper.ensureInitialized()
        .equalsValue(this as ConversationState, other);
  }

  @override
  int get hashCode {
    return ConversationStateMapper.ensureInitialized()
        .hashValue(this as ConversationState);
  }
}
...
extension ConversationStateValueCopy<$R, $Out>
  ...
  ConversationStateCopyWith<$R, ConversationState, $Out>
      get $asConversationState => $base
          .as((v, t, t2) => _ConversationStateCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class ConversationStateCopyWith<$R, $In extends ConversationState,
    $Out> implements ClassCopyWith<$R, $In, $Out> {
  ListCopyWith<$R, AppConversation,
...
class _ConversationStateCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<$R, AppConversation,
          AppConversationCopyWith<$R, AppConversation, AppConversation>>
      get conversations => ListCopyWith($value.conversations,
          (v, t) => v.copyWith.$chain(t), (v) => call(conversations: v));
  @override
  $R call(
          {ConversationStatus? status,
          List<AppConversation>? conversations,
