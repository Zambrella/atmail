...
class ConversationArchiveCubit extends Cubit<ConversationArchiveState> {
  ConversationArchiveCubit(this._conversationRepository, {required this.conversationId})
