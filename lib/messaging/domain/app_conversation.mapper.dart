...
class AppConversationMapper extends ClassMapperBase<AppConversation> {
  ...
  static const Field<AppConversation, String> _f$subject = Field(
    'subject',
    _$subject,
  );
  static List<String> _$participants(AppConversation v) => v.participants;
  static const Field<AppConversation, List<String>> _f$participants = Field(
    'participants',
    _$participants,
  );
  static DateTime _$createdAt(AppConversation v) => v.createdAt;
  static const Field<AppConversation, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
  );
  static String _$createdBy(AppConversation v) => v.createdBy;
  static const Field<AppConversation, String> _f$createdBy = Field(
    'createdBy',
    _$createdBy,
  );
  static List<AppMessage> _$messages(AppConversation v) => v.messages;
  static const Field<AppConversation, List<AppMessage>> _f$messages = Field(
    'messages',
    _$messages,
  );
  static String? _$previousConversationId(AppConversation v) =>
      v.previousConversationId;
  static const Field<AppConversation, String> _f$previousConversationId = Field(
    'previousConversationId',
    _$previousConversationId,
    opt: true,
  );
  static bool _$isArchived(AppConversation v) => v.isArchived;
  static const Field<AppConversation, bool> _f$isArchived = Field(
    'isArchived',
    _$isArchived,
    opt: true,
    def: false,
  ...
  static const Field<AppConversation, bool> _f$hasLeft = Field(
    'hasLeft',
    _$hasLeft,
    opt: true,
    def: false,
  ...
  static const Field<AppConversation, Map<String, dynamic>> _f$metadata = Field(
    'metadata',
    _$metadata,
    opt: true,
    def: const {},
  );
  static String? _$latestMessageSender(AppConversation v) =>
      v.latestMessageSender;
  static const Field<AppConversation, String> _f$latestMessageSender = Field(
    'latestMessageSender',
    _$latestMessageSender,
    mode: FieldMode.member,
  );
  static MessageContent? _$latestMessage(AppConversation v) => v.latestMessage;
  static const Field<AppConversation, MessageContent> _f$latestMessage = Field(
    'latestMessage',
    _$latestMessage,
    mode: FieldMode.member,
  );
  static DateTime? _$latestMessageDate(AppConversation v) =>
      v.latestMessageDate;
  static const Field<AppConversation, DateTime> _f$latestMessageDate = Field(
    'latestMessageDate',
    _$latestMessageDate,
    mode: FieldMode.member,
  );
  ...
  final MappableFields<AppConversation> fields = const {
    ...
    #latestMessageSender: _f$latestMessageSender,
    #latestMessage: _f$latestMessage,
    #latestMessageDate: _f$latestMessageDate,
  };
...
mixin AppConversationMappable {
  ...
  Map<String, dynamic> toMap() {
    return AppConversationMapper.ensureInitialized().encodeMap<AppConversation>(
      this as AppConversation,
    );
  }
  ...
  @override
  String toString() {
    return AppConversationMapper.ensureInitialized().stringifyValue(
      this as AppConversation,
    );
  }
  ...
  bool operator ==(Object other) {
    return AppConversationMapper.ensureInitialized().equalsValue(
      this as AppConversation,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return AppConversationMapper.ensureInitialized().hashValue(
      this as AppConversation,
    );
  }
}
