...
class AppMessageMapper extends ClassMapperBase<AppMessage> {
  ...
  static const Field<AppMessage, DateTime> _f$timestamp = Field(
    'timestamp',
    _$timestamp,
  );
  static MessageContent _$content(AppMessage v) => v.content;
  static const Field<AppMessage, MessageContent> _f$content = Field(
    'content',
    _$content,
  );
  static MessageStatus _$status(AppMessage v) => v.status;
  static const Field<AppMessage, MessageStatus> _f$status = Field(
    'status',
    _$status,
  );
  ...
  static const Field<AppMessage, Map<String, dynamic>> _f$metadata = Field(
    'metadata',
    _$metadata,
    opt: true,
    def: const {},
  );
  static String _$id(AppMessage v) => v.id;
  static const Field<AppMessage, String> _f$id = Field(
    'id',
    _$id,
...
mixin AppMessageMappable {
  String toJson() {
    return AppMessageMapper.ensureInitialized().encodeJson<AppMessage>(
      this as AppMessage,
    );
  }

  Map<String, dynamic> toMap() {
    return AppMessageMapper.ensureInitialized().encodeMap<AppMessage>(
      this as AppMessage,
    );
  }
  ...
  @override
  String toString() {
    return AppMessageMapper.ensureInitialized().stringifyValue(
      this as AppMessage,
    );
  }
  ...
  bool operator ==(Object other) {
    return AppMessageMapper.ensureInitialized().equalsValue(
      this as AppMessage,
      other,
    );
  }
