...
class AvailableAtsignsStateMapper
  ...
  static const Field<AvailableAtsignsState, List<String>> _f$atsigns =
      Field('atsigns', _$atsigns, opt: true, def: const []);
  static bool _$isLoading(AvailableAtsignsState v) => v.isLoading;
  static const Field<AvailableAtsignsState, bool> _f$isLoading =
      Field('isLoading', _$isLoading, opt: true, def: false);
  static String? _$error(AvailableAtsignsState v) => v.error;
  static const Field<AvailableAtsignsState, String> _f$error =
...
mixin AvailableAtsignsStateMappable {
  ...
  AvailableAtsignsStateCopyWith<AvailableAtsignsState, AvailableAtsignsState,
      AvailableAtsignsState> get copyWith => _AvailableAtsignsStateCopyWithImpl<
          AvailableAtsignsState, AvailableAtsignsState>(
      this as AvailableAtsignsState, $identity, $identity);
  @override
  String toString() {
    return AvailableAtsignsStateMapper.ensureInitialized()
        .stringifyValue(this as AvailableAtsignsState);
  }

  @override
  bool operator ==(Object other) {
    return AvailableAtsignsStateMapper.ensureInitialized()
        .equalsValue(this as AvailableAtsignsState, other);
  }

  @override
  int get hashCode {
    return AvailableAtsignsStateMapper.ensureInitialized()
        .hashValue(this as AvailableAtsignsState);
  }
}
...
class _AvailableAtsignsStateCopyWithImpl<$R, $Out>
  ...
  @override
  ListCopyWith<$R, String, ObjectCopyWith<$R, String, String>> get atsigns =>
      ListCopyWith($value.atsigns, (v, t) => ObjectCopyWith(v, $identity, t),
          (v) => call(atsigns: v));
  @override
